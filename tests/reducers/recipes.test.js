...
/*
Challenge !
  x adapter les tests suite à l'ajout de loading (=> les tests ne passent plus,
    mais le code est bon, c'est les tests qu'il faut adapter)
  x avancer sur le challenge de jeudi soir si pas fini (authentification)
  x quand on a un deuxième reducer : écrire des tests pour ce reducer (état initial,
    au moins une action)
  - BONUS : mettre en valeur les recettes préférées de l'utilisateur (bordure colorée,
    icône...)
*/
